                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="id_pilar_pbp_1" id="id_pilar_pbp_1" placeholder="Pilar 1" value="<?= set_value('id_pilar_pbp_1'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="id_pilar_pbp_2" id="id_pilar_pbp_2" placeholder="Pilar 2" value="<?= set_value('id_pilar_pbp_2'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="id_pilar_pbp_3" id="id_pilar_pbp_3" placeholder="Pilar 3" value="<?= set_value('id_pilar_pbp_3'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="id_pilar_pbp_4" id="id_pilar_pbp_4" placeholder="Pilar 4" value="<?= set_value('id_pilar_pbp_4'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="id_pilar_pbp_5" id="id_pilar_pbp_5" placeholder="Pilar 5" value="<?= set_value('id_pilar_pbp_5'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="id_pilar_pbp_6" id="id_pilar_pbp_6" placeholder="Pilar 6" value="<?= set_value('id_pilar_pbp_6'); ?>">
                                <small class="info help-block">
                            ...
                            <small class="info help-block">
                                                ...
                                                <div class="form-group ">
                            <label for="id_guru" class="col-sm-2 control-label">Wali Kelas 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="id_guru" id="id_guru" placeholder="Wali Kelas" value="<?= set_value('id_guru'); ?>">
                                <small class="info help-block">
