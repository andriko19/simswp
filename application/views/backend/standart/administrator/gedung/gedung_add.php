...
<section class="content-header">
    <h1>
        Gedung        <small><?= cclang('new', ['Gedung']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Gedung']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_gedung', 
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_gedung" id="nama_gedung" placeholder="Nama Gedung" value="<?= set_value('nama_gedung'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="jumlah_lantai" id="jumlah_lantai" placeholder="Jumlah Lantai" value="<?= set_value('jumlah_lantai'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="panjang" id="panjang" placeholder="Panjang" value="<?= set_value('panjang'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="lebar" id="lebar" placeholder="Lebar" value="<?= set_value('lebar'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/gedung/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
