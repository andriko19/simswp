...
<section class="content-header">
    <h1>
        Rombel        <small><?= cclang('new', ['Rombel']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Rombel']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_rombel', 
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_rombel" id="nama_rombel" placeholder="Nama Rombel" value="<?= set_value('nama_rombel'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <small class="info help-block">
                                                ...
                                                <div class="form-group ">
                            <label for="periode" class="col-sm-2 control-label">Tahun Ajaran 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/rombel/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
