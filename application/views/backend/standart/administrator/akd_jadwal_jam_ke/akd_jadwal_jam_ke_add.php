...
<section class="content-header">
    <h1>
        Akd Jadwal Jam Ke        <small><?= cclang('new', ['Akd Jadwal Jam Ke']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Akd Jadwal Jam Ke']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/akd_jadwal_jam_ke/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
