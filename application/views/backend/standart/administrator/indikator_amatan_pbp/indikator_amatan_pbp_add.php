...
<section class="content-header">
    <h1>
        Indikator Amatan Pbp        <small><?= cclang('new', ['Indikator Amatan Pbp']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Indikator Amatan Pbp']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kode_indikator" id="kode_indikator" placeholder="Kode Indikator" value="<?= set_value('kode_indikator'); ?>">
                        ...
                        <div class="form-group ">
                            <label for="id_dimensi_pbp" class="col-sm-2 control-label">Dimensi Pbp 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_dimensi_pbp" id="id_dimensi_pbp" data-placeholder="Select Id Dimensi Pbp" >
                                    ...
                                    <option value="<?= $row->id_dimensi_pbp ?>"><?= $row->dimensi_pbp; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="indikator" id="indikator" placeholder="Indikator" value="<?= set_value('indikator'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/indikator_amatan_pbp/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
