                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Agama</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/agama/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="agama" id="agama" placeholder="Agama" value="<?= set_value('agama', $agama->agama); ?>">
                                <small class="info help-block">
                                <b>Input Agama</b> Max Length : 50.</small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="keterangan" id="keterangan" placeholder="Keterangan" value="<?= set_value('keterangan', $agama->keterangan); ?>">
                                <small class="info help-block">
