                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/semester/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <label for="id_periode" class="col-sm-2 control-label">Tahun Ajaran
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                            ...
                            <div class="col-sm-8">
                                <input type="hidden" class="form-control" name="semester" id="semester1" placeholder="Semester1" value="<?= set_value('semester', $semester->semester); ?>">
                                <select  class="form-control chosen chosen-select-deselect" name="semester" id="semester" data-placeholder="Select Jenis Semester" >
                                    <option value="">--Pilih--</option>
                                    <option value="Ganjil">Ganjil</option>
                                    <option value="Genap">Genap</option>
                                </select>
                                <small class="info help-block">
                                <b>Input Semester</b> Max Length : 11.</small>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
