                            ...
                            <div class="row">
                              <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                  ...
                                  <div class="col-sm-12">
                                      <label>Periode Aktif<span class="required">*</span></label>
                                      <div class="row">
                                        <div class="col-md-6 ">
                                          
                                          <select class="selectpicker" data-width="100%" name="language">

                                            <?php foreach (db_get_all_data('periode',null) as $lang): ?>
                                                <option <?= $this->config->item('periode') == $lang->id_periode ? 'selected' : ''; ?>  value="<?= $lang->periode; ?>"><?= $lang->periode; ?></option>
                                            <?php endforeach; ?>
                                            </select>
                                        </div>
                                      </div>
