                            ...
                            <div class="col-sm-8">
                              <fieldset>
                                ...
                                <div class="form-group" id="laporan_mingguan_form">
                                  ...
                                  <!-- <label for="tahun" class="col-sm-1 control-label">Tahun:<i class="required">*</i></label>
                                  <div class="col-sm-2">
                                      <input type="text" class="form-control pull-right" name="tahun" id="tahun" placeholder="Isikan Tahun">
                                      <small class="info help-block">
                                      <b>Input Tahun</b> (Contoh : 2021).</small>
                                  </div> -->
                                ...
                                <div class="form-group">
                                  <label for="sekolah" class="col-sm-2 control-label">Sekolah:</label>
                                  <div class="col-sm-5">
                                ...
                                <div class="form-group">
                                  <label for="id_rombel" class="col-sm-2 control-label">Rombel:</label>
                                  <div class="col-sm-5">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-5">
                                    <select  class="form-control chosen chosen-select-deselect" name="ppbp" id="ppbp" data-placeholder="Select PPBP" >
                                      ...
                                      <?php foreach (db_get_all_data('guru') as $row): ?>
                                     <!--  <option value="<?= $row->id_guru ?>"><?= $row->nama_guru; ?></option> -->
                                      <option <?=  $row->id_guru ==  196 ? 'selected' : ''; ?> value="<?= $row->id_guru ?>"><?= $row->nama_guru; ?></option>
                                      <?php endforeach; ?>
                                    </select>
                                    <small class="info help-block">
