...
<section class="content-header">
    <h1>
        Siswa <small> Improt Excel</small>
    </h1>
    <ol class="breadcrumb">
                    ...
                    <div class="box box-widget widget-user-2"> 
                        ...
                        <div class="widget-user-header ">
                            <div class="row pull-right">
                              ...
                              <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', ['M Mahasiswa']); ?>  (Ctrl+a)" href="<?=  site_url('administrator/siswa'); ?>"><i class="fa fa-plus-square-o" ></i> Siswa List</a>
                              <?php }) ?>
                            </div>
                        ...
                        <div class="form-group ">
                            <label for="id_status" class="col-sm-2 control-label"><a href="<?= base_url('excel/format/list kode import excel data siswa.xlsx'); ?>"> Download List Kode Import Excel Siswa</a>
                            <!-- <i class="required">*</i> -->
                            </label>
                        </div>

                        <div class="form-group ">
                            <label for="id_status" class="col-sm-2 control-label"><a href="<?= base_url('excel/format/format siswa.xlsx'); ?>"> Download Format Excel </a>
                            <!-- <i class="required">*</i> -->
                            </label>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/siswa/add_save_upload',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
       ...
       $('#import_excel_galery').fineUploader({
          ...
          request: {
              endpoint: BASE_URL + '/administrator/siswa/upload_excel_file',
              params : params
          },
          deleteFile: {
              enabled: true, 
              endpoint: BASE_URL + '/administrator/siswa/delete_excel_file',
          },
          thumbnails: {
              placeholders: {
          ...
          callbacks: {
              ...
              onSubmit : function(id, name) {
                  ...
                  $.get(BASE_URL + '/administrator/siswa/delete_excel_file/' + uuid);
              },
