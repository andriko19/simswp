...
<section class="content-header">
    <h1>
        Siswa <small><?= cclang('new', ['Siswa']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Siswa']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_siswa',
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nipd" id="nipd" placeholder="NIPD" value="<?= set_value('nipd'); ?>">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Siswa" value="<?= set_value('nama'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                                <div class="col-md-2 padding-left-0">
                                    <label>
                                        <input type="radio" class="flat-red" name="kebutuhan_khusus" id="kebutuhan_khusus" value="yes">
                                        <?= cclang('yes'); ?>
                                    </label>
                                </div>
                                <div class="col-md-14">
                                    <label>
                                        <input type="radio" class="flat-red" name="kebutuhan_khusus" id="kebutuhan_khusus" value="no">
                                        <?= cclang('no'); ?>
                                    </label>
                                </div>
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kelurahan" id="kelurahan" placeholder="Desa/Kelurahan" value="<?= set_value('kelurahan'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="jenis_tinggal" id="jenis_tinggal" placeholder="Jenis Tinggal" value="<?= set_value('jenis_tinggal'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="alat_transportasi" id="alat_transportasi" placeholder="Alat Transportasi" value="<?= set_value('alat_transportasi'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="hp" id="hp" placeholder="HP" value="<?= set_value('hp'); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="email" id="email" placeholder="Email Aktif" value="<?= set_value('email'); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="skhun" id="skhun" placeholder="SKHUN" value="<?= set_value('skhun'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="penerima_kps" id="penerima_kps" placeholder="Penerima KPS" value="<?= set_value('penerima_kps'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="no_kps" id="no_kps" placeholder="No. KPS" value="<?= set_value('no_kps'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="siswa_foto_uuid" id="siswa_foto_uuid" type="hidden" value="<?= set_value('siswa_foto_uuid'); ?>">
                                <input class="data_file" name="siswa_foto_name" id="siswa_foto_name" type="hidden" value="<?= set_value('siswa_foto_name'); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="tahun_lahir_ayah" id="tahun_lahir_ayah" placeholder="Tahun Lahir Ayah" value="<?= set_value('tahun_lahir_ayah'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                                <div class="col-md-2 padding-left-0">
                                    <label>
                                        <input type="radio" class="flat-red" name="kebutuhan_khusus_ayah" id="kebutuhan_khusus_ayah" value="yes">
                                        <?= cclang('yes'); ?>
                                    </label>
                                </div>
                                <div class="col-md-14">
                                    <label>
                                        <input type="radio" class="flat-red" name="kebutuhan_khusus_ayah" id="kebutuhan_khusus_ayah" value="no">
                                        <?= cclang('no'); ?>
                                    </label>
                                </div>
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="no_telpon_ayah" id="no_telpon_ayah" placeholder="No. Telepon Ayah" value="<?= set_value('no_telpon_ayah'); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="tahun_lahir_ibu" id="tahun_lahir_ibu" placeholder="Tahun Lahir Ibu" value="<?= set_value('tahun_lahir_ibu'); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                                <div class="col-md-2 padding-left-0">
                                    <label>
                                        <input type="radio" class="flat-red" name="kebutuhan_khusus_ibu" id="kebutuhan_khusus_ibu" value="yes">
                                        <?= cclang('yes'); ?>
                                    </label>
                                </div>
                                <div class="col-md-14">
                                    <label>
                                        <input type="radio" class="flat-red" name="kebutuhan_khusus_ibu" id="kebutuhan_khusus_ibu" value="no">
                                        <?= cclang('no'); ?>
                                    </label>
                                </div>
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="no_telpon_ibu" id="no_telpon_ibu" placeholder="No. Telepon Ibu" value="<?= set_value('no_telpon_ibu'); ?>">
                                <small class="info help-block">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="tahun_lahir_wali" id="tahun_lahir_wali" placeholder="Tahun Lahir Wali" value="<?= set_value('tahun_lahir_wali'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="pendidikan_wali" id="pendidikan_wali" placeholder="Pendidikan Wali" value="<?= set_value('pendidikan_wali'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="pekerjaan_wali" id="pekerjaan_wali" placeholder="Pekerjaan Wali" value="<?= set_value('pekerjaan_wali'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="penghasilan_wali" id="penghasilan_wali" placeholder="Penghasilan Wali" value="<?= set_value('penghasilan_wali'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="angkatan" id="angkatan" placeholder="Angkatan/Tahun Masuk" value="<?= set_value('angkatan'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="status_awal" id="status_awal" placeholder="Status Awal" value="<?= set_value('status_awal'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select" name="tingkat" id="tingkat" data-placeholder="Select Tingkat">
                                    ...
                                    <option value="10">X SMA</option>
                                    <option value="11">XI SMA</option>
                                    <option value="12">XII SMA</option>
                                    <option value="10K">X SMK</option>
                                    <option value="11K">XI SMK</option>
                                    <option value="12K">XII SMK</option>
                                </select>
                                <small class="info help-block">
                                </small>
                            </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="id_sesi" id="id_sesi" placeholder="Sesi" value="<?= set_value('id_sesi'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.btn_save').click(function() {
            ...
            $.ajax({
                    url: BASE_URL + '/administrator/siswa/add_save',
                    type: 'POST',
                    dataType: 'json',
                    data: data_post,
                })
                .done(function(res) {
                    if (res.success) {
                        var id_foto = $('#siswa_foto_galery').find('li').attr('qq-file-id');
                        ...
                        if (typeof id_foto !== 'undefined') {
                            $('#siswa_foto_galery').fineUploader('deleteFile', id_foto);
                        }
