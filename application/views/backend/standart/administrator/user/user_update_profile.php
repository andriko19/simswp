               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <?= form_open(base_url('administrator/user/edit_save/'.$this->uri->segment(4)), [
                   ...
                   <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" name="username" id="username" placeholder="Username" value="<?= set_value('username', $user->username); ?>" readonly>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input name="user_avatar_old" id="user_avatar_old" type="text" value="<?= $user->avatar; ?>">
                            <input name="user_avatar_uuid" id="user_avatar_uuid" type="text" value="<?= set_value('user_avatar_uuid'); ?>">
                            <!-- <input name="user_avatar_name" id="user_avatar_name" type="text" value="<?= set_value('user_avatar_name'); ?>"> -->
                            <input name="user_avatar_name" id="user_avatar_name" type="text" value="<?= set_value('user_avatar_name', $user->avatar); ?>">
