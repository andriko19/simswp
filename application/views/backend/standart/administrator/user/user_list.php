               ...
               <div class="row">
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                      ...
                      <?php
                        // $a = $this->aauth->is_admin();
                        $a = $this->session->groups;
                        // echo $a;
                        if ($a == 1) { ?>
                          <div class="col-sm-1 padd-left-0 ">
                            <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/user/guru'); ?>" title="Guru">
                              Guru
                            </a>
                          </div>
                          <div class="col-sm-1 padd-left-0 ">
                            <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/user/siswa'); ?>" title="Siswa">
                              Siswa
                            </a>
                          </div>
                        <?php } elseif ($a == 16) { ?>
                          <div class="col-sm-1 padd-left-0 ">
                            <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/user/guru_smk'); ?>" title="Guru SMK">
                              Guru
                            </a>
                          </div>
                          <div class="col-sm-1 padd-left-0 ">
                            <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/user/siswa_smk'); ?>" title="Siswa SMK">
                              Siswa
                            </a>
                          </div>
                        <?php } elseif ($a == 15) { ?>
                          <div class="col-sm-1 padd-left-0 ">
                            <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/user/guru_sma'); ?>" title="Guru SMA">
                              Guru
                            </a>
                          </div>
                          <div class="col-sm-1 padd-left-0 ">
                            <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/user/siswa_sma'); ?>" title="Siswa SMA">
                              Siswa
                            </a>
                          </div>
                        <?php } elseif ($a == 14) { ?>
                          <div class="col-sm-1 padd-left-0 ">
                            <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/user/guru_smp'); ?>" title="Guru SMP">
                              Guru
                            </a>
                          </div>
                          <div class="col-sm-1 padd-left-0 ">
                            <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/user/siswa_smp'); ?>" title="Siswa SMP">
                              Siswa
                            </a>
                          </div>
                        <?php  }
