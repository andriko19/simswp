...
<div class="wrapper">
  ...
  <header class="main-header">
    <a href="<?= site_url('administrator/dashboard'); ?>" class="logo">
      <span class="logo-mini">S<b>I</b></span>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <?php if ($this->aauth->is_loggedin()) { ?>
        ...
        <ul class="nav navbar-nav">
          ...
          <a href="<?= site_url('administrator/role/'); ?>">
               
              <span class="hidden-xs">Pilih Role</span>
              </a>
          </li>
        </ul>
      <?php } ?>  
...
<script src="<?= BASE_ASSET; ?>/js/chosen.js"></script>
