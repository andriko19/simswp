    ...
    (e = (function () {
      ...
      return (
        ...
        (t.prototype.results_option_build = function (t) {
          var e, s, i, r, o, n, l;
          for (
            e = "", r = 0, l = this.results_data, o = 0, n = l.length;
            n > o &&
            ((s = l[o]),
            (i = ""),
        ...
        (t.prototype.result_add_group = function (t) {
          ...
          return (t.search_match || t.group_match) && t.active_options > 0
            ? ((e = []), e.push("group-result"), t.classes && e.push(t.classes), (s = document.createElement("li")), (s.className = e.join(" ")), (s.innerHTML = t.search_text), t.title && (s.title = t.title), this.outerHTML(s))
            : "";
        }),
        ...
        (t.prototype.winnow_results = function () {
          ...
          for (this.no_results_clear(), i = 0, o = this.get_search_text(), t = o.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), h = new RegExp(t, "i"), s = this.get_search_regex(t), _ = this.results_data, c = 0, a = _.length; a > c; c++)
            (e = _[c]),
              (e.search_match = !1),
              (r = null),
              this.include_option_in_results(e) &&
                (e.group && ((e.group_match = !1), (e.active_options = 0)),
                null != e.group_array_index && this.results_data[e.group_array_index] && ((r = this.results_data[e.group_array_index]), 0 === r.active_options && r.search_match && (i += 1), (r.active_options += 1)),
                ...
                (e.group && !this.group_search) ||
                  ...
                  e.search_match
                    ? (o.length && ((n = e.search_text.search(h)), (l = e.search_text.substr(0, n + o.length) + "</em>" + e.search_text.substr(n + o.length)), (e.search_text = l.substr(0, n) + "<em>" + l.substr(n))),
      ...
      return (
        ...
        (s.prototype.set_up_html = function () {
          ...
          return (
            ...
            (s = { class: e.join(" "), style: "width: " + this.container_width() + ";", title: this.form_field.title }),
        ...
        (s.prototype.container_mousedown = function (e) {
          return this.is_disabled || (e && "mousedown" === e.type && !this.results_showing && e.preventDefault(), null != e && t(e.target).hasClass("search-choice-close"))
            ? void 0
            : (this.active_field
        ...
        (s.prototype.choice_build = function (e) {
          ...
          return (
            ...
            e.disabled
              ...
              : ((i = t("<a />", { class: "search-choice-close", "data-option-array-index": e.array_index })),
        ...
        (s.prototype.choice_destroy = function (t) {
          return this.result_deselect(t[0].getAttribute("data-option-array-index"))
            ? (this.show_search_field_default(), this.is_multiple && this.choices_count() > 0 && this.search_field.val().length < 1 && this.results_hide(), t.parents("li").first().remove(), this.search_field_scale())
            : void 0;
        }),
            ...
            ? ((e = this.result_highlight),
              ...
              this.is_multiple && this.max_selected_options <= this.choices_count()
                ...
                : (this.is_multiple ? e.removeClass("active-result") : this.reset_single_select_options(),
                  ...
                  this.show_search_field_default(),
                  (this.is_multiple || this.form_field.selectedIndex !== this.current_selectedIndex) && this.form_field_jq.trigger("change", { selected: this.form_field.options[s.options_index].value }),
        ...
        (s.prototype.keydown_backstroke = function () {
          ...
          return this.pending_backstroke
            ...
            : ((t = this.search_container.siblings("li.search-choice").last()),
              t.length && !t.hasClass("search-choice-disabled") ? ((this.pending_backstroke = t), this.single_backstroke_delete ? this.keydown_backstroke() : this.pending_backstroke.addClass("search-choice-focus")) : void 0);
        }),
        ...
        (s.prototype.search_field_scale = function () {
          ...
          if (this.is_multiple) {
            for (
              i = 0, l = 0, o = "position:absolute; left: -1000px; top: -1000px; display:none;", n = ["font-size", "font-style", "font-weight", "font-family", "line-height", "text-transform", "letter-spacing"], h = 0, c = n.length;
              c > h;
              h++
            )
              (r = n[h]), (o += r + ":" + this.search_field.css(r) + ";");
            return (
              (e = t("<div />", { style: o })),
              ...
              l > s - 10 && (l = s - 10),
              this.search_field.css({ width: l + "px" })
            );
          }
        }),
        s
