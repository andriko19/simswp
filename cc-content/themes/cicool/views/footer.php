...
<!-- ======= Footer ======= -->
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        <strong>Copyright &copy; 2020-<?=date('Y'); ?> <a href="#" ><?= get_option('site_name'); ?></a>.</strong> All rights reserved.
      </div>
      <div class="credits">
  ...
  <script src="<?= theme_asset(); ?>vendor/waypoints/jquery.waypoints.min.js"></script>
  <script src="<?= theme_asset(); ?>vendor/counterup/counterup.min.js"></script>
